...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var naranja=objetoMisterioso.numeroMisterioso*5
   return naranja
}
...
function tieneEmail(objetoUsuario) {
   ...
   if (objetoUsuario.email===null|| tienePropiedad===false) return false
   else return true
}
...
// 
   // objetoMuchosUsuarios.forEach(numero=>{
   //    numero.esPremium=true
   // })
   // return objetoMuchosUsuarios
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   var resultado=0
   for (const usuario of objetoUsuario.posts){
      resultado=resultado+usuario.likes
