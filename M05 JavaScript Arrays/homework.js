...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var arraymasuno = array.map((pipo)=>{
      return pipo+1
   })
   return arraymasuno
}
...
function arrayContiene(array, elemento) {
   ...
   // Tu código:
   pepito= array.includes(elemento)
   return pepito
}
